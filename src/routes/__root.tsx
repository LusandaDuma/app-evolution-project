...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A luxurious agriculture learning platform for the modern grower." },
      { name: "author", content: "Imbewu" },
      { property: "og:title", content: "Imbewu — Agriculture Learning, Cultivated" },
      { property: "og:description", content: "A luxurious agriculture learning platform for the modern grower." },
